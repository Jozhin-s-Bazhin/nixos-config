...
let
  ...
  openfoam-2306 = pkgs.callPackage (import ./openfoam) { scotch = scotch-shared; };
  openfoam-2312 = openfoam-2306.override {
    version = "2312";
    hash = "0wgfyz4q7xr0vlv4znfxpxyp8jb53q5pl17k312dyb3x8gkdx2z4";
  };
